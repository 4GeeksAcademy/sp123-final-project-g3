...
class Postulations(db.Model):
    ...
    status = db.Column(db.String(100), nullable=False, default="Pendiente")
    ...
    def serialize(self):
        return {
            ...
            "created_at": self.created_at,
            "job": self.job_to.serialize() if self.job_to else None,
            "cv": self.cv_to.serialize() if self.cv_to else None,
        }